...
function buildChatSystemPrompt(
  ...
  return [
    ...
    '',
    'AUDIO GENERATION:',
    'If the user requests audio (music, voice narration, or sound effects):',
    '- Music: "Add background music" or "Add upbeat hip-hop music"',
    '- Voice narration: "Add voice narration saying \'welcome to the video\'"',
    '- Sound effects: "Add a whoosh sound effect"',
    '',
    'The system will automatically:',
    '1. Generate/fetch the audio (Pixabay for music/SFX, ElevenLabs for voice)',
    '2. Save it as an asset',
    '3. Send you a system message with the asset ID',
    '',
    'When you receive the system message confirming audio generation, you MUST:',
    '1. Add the audio asset to the "assets" array in your spec (copy from system message)',
    '2. Add an audio clip to the audio track referencing that asset ID',
    '',
    'Example audio clip format:',
    '{',
    '  "id": "audio-background",',
    '  "type": "audio",',
    '  "assetId": "asset-123",  // Use the ID from system message',
    '  "startTime": 0,           // When audio starts in timeline',
    '  "duration": 20,           // How long to play',
    '  "volume": 0.5             // Optional: 0.0 to 1.0, default 1.0',
    '}',
    '',
    'RESPONSE FORMAT:',
