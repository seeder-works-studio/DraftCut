...
export function buildSystemPrompt(
  ...
  return [
    ...
    '   Props: { lines: string[], animationStyle: "bounce"|"scale"|"rotate"|"slide"|"fade", timing: "word"|"line", stagger: number, fontSize, color, align, verticalAlign, emphasizeColor }',
    '   Create dynamic text sequences with professional motion. Use for promotional videos and announcements.',
    '',
    '10. BrandLogo: Animated logo with entrance effects',
    '    Props: { logoAssetId: string, animationType: "bounce"|"pulse"|"slide"|"rotate"|"fade", scale: number, position: "center"|"top-left"|"top-right"|"bottom-left"|"bottom-right", loop: boolean }',
    '    Professional logo animations with optional looping. Use for branding moments.',
    '',
